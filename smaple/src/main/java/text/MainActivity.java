...
import tableview.TableAdapter;
import tableview.TableLayout;
import win.smartown.android.app.tablelayout.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableLayout.setCallback(new TableLayout.Callback() {
            ...
            public void onResult(int x, int y) {
                Toast.makeText(MainActivity.this, "坐标：x=" + x + "    y=" + y, Toast.LENGTH_SHORT).show();
            }
        });
        initContent();
        firstRowAsTitle();
