...
public class TableColumn extends LinearLayout {
    ...
    public static float maxTextViewWidth;
    public static float mTableRowHeight;
    public static float mTableRowWidth;
    ...
    private void initContent() {
        ...
        mTableRowHeight = callback.getTableLayout().getTableRowHeight();
        mTableRowWidth = padding * 2 + maxTextViewWidth;
